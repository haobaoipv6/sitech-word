...
public class AutoDetector {
    ...
    private static final Map<DirectoryWatcher, IResource> resourceLoaders = new HashMap<>();
     ...
     */
    public static void loadAndWatch(IResource resourceLoader, String resourcePaths) {
        LOGGER.info("开始加载资源");
     ...
     * @throws IOException 
     */
    private static List<String> loadClasspathResource(String resource, IResource resourceLoader, String resourcePaths) throws IOException{
        List<String> result = new ArrayList<>();
     ...
     * @return 资源内容
     */
    private static List<String> loadHttpResource(String resource, IResource resourceLoader) throws MalformedURLException, IOException {
        List<String> result = new ArrayList<>();
    ...
    private static void watchHttp(String resource, final IResource resourceLoader){
    ...
    private static final class HttpResourceChangeRedisListener extends JedisPubSub {
        private IResource resourceLoader;
        public HttpResourceChangeRedisListener(IResource resourceLoader){
     ...
     * @throws IOException 
     */
    private static List<String> loadNoneClasspathResource(String resource, IResource resourceLoader, String resourcePaths) throws IOException {
        List<String> result = new ArrayList<>();
     ...
     * @return 目录所有资源内容
     */
    private static List<String> loadAndWatchDir(Path path, IResource resourceLoader, String resourcePaths) {
            ...
            public void execute(WatchEvent.Kind<?> kind, String path) {
                ...
                if(System.currentTimeMillis() - lastExecute > 1000){
                    ...
                    synchronized(AutoDetector.class){
                        ...
                        IResource loader = resourceLoaders.get(dw);
                        LOGGER.info("重新加载数据");
     ...
     * @param file 文件
     */
    private static void watchFile(final File file, IResource resourceLoader, String resourcePaths) {
