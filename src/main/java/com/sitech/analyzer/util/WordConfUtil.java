 ...
 * @author hb
 */
public class WordConfUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(WordConfUtil.class);
    ...
    private static void loadConf(String confFile) {
        InputStream in = WordConfUtil.class.getClassLoader().getResourceAsStream(confFile);
        if(in == null){
